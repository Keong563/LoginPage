...
public class justGone extends AppCompatActivity{ //implements NavigationView.OnNavigationItemSelectedListener{
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        mRef = mFirebaseDatabase.getReference("requestFoods");
...
//        finish();
//        startActivity(new Intent(justGone.this, MainActivity.class));
//    }
//
//    @Override
...
//                startActivity(new Intent(justGone.this, ProfileActivity.class));
//                break;
//            }
//        }
                    ...
                    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Toast.makeText(justGone.this, "This item has been request by " + email, Toast.LENGTH_SHORT).show();
...
//            startActivity(new Intent(justGone.this,insertFood.class));
//        }
//        else if (id == R.id.nav_just_gone) {
//            startActivity(new Intent(justGone.this,justGone.class));
//
